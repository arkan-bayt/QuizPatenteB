    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center p-5">
      <div className="w-full max-w-[400px] anim-up">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Quiz Patente B</h1>
          <p className="mt-2 text-sm text-gray-500">Piattaforma per la preparazione all&apos;esame della patente B</p>
        </div>

        {/* Login Card */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
          <h2 className="text-base font-bold text-gray-900 mb-6">Accedi al tuo account</h2>
          ...
          <form onSubmit={handle} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold mb-2 text-gray-500 uppercase tracking-wider">Username</label>
              <input
                type="text"
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 outline-none transition-all text-sm"
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 text-gray-500 uppercase tracking-wider">Password</label>
              <div className="relative">
                <input
                  type={showPw ? 'text' : 'password'}
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 pr-11 text-gray-900 outline-none transition-all text-sm"
        ...
        <div className="text-center mt-8 space-y-1">
          <p className="text-xs text-gray-400">Quiz Patente B v3.0 · Open Source</p>
