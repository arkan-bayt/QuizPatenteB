...
export type Screen = 'loading' | 'login' | 'home' | 'chapter' | 'quiz' | 'exam' | 'result' | 'wrong' | 'stats' | 'admin' | 'resume' | 'aiAnalysis' | 'aiChat' | 'studyPlan' | 'theory' | 'theoryBook' | 'teacherDashboard' | 'studentDashboard' | 'studentsList' | 'assignmentResults' | 'createAssignment';
